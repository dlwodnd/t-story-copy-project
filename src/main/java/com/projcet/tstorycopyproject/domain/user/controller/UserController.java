...
public class UserController {
    ...
    public ResponseEntity<CustomResponse<UserRefreshTokenRp>> userRefreshToken(HttpServletRequest servletRequest) {

        return ResponseEntity.ok(new CustomResponse<>(userService.refreshAccessToken(servletRequest)));
    }
    // 유저 로그아웃
    @PostMapping("/logout")
    public ResponseEntity<CustomResponse<Void>> userLogout(HttpServletResponse response){
